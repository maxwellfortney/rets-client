...
exports.findReplyCodeName = exports.ReplyCode = void 0;
/**
...
const codeKeys = Object.keys(exports.ReplyCode);
/**
 * Find name using reply code
 * @param code Reply code
 */
function findReplyCodeName(code) {
    code = +code;
    for (let i = -1; ++i < codeKeys.length;) {
        const targetCode = exports.ReplyCode[codeKeys[i]];
...
exports.findReplyCodeName = findReplyCodeName;
//# sourceMappingURL=ReplyCode.js.map